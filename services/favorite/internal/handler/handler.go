...
import (
	...
	"github.com/student/labor-exchange-backend/services/favorite/internal/repository"
	"log"
	"net/http"
	"strconv"
)
...
func Create(w http.ResponseWriter, r *http.Request) {
	...
	favorite := &internal.Favorite{JobSeekerID: requestBody.JobSeekerID, EmployerID: requestBody.EmployerID}

	if err := repo.Create(favorite); err != nil {
...
func Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := repo.Update(id, requestBody.JobSeekerID, requestBody.EmployerID); err != nil {
